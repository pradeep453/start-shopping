...
public class ProductDAOImpl implements ProductDAO {
	...
	public List<Product> getLatestActiveProducts(int count) {
		String selectActiveProductsByCount = " FROM  Product WHERE active = :active ORDER BY id   ";
		return sessionFactory.getCurrentSession().createQuery(selectActiveProductsByCount, Product.class)
